...
import imag from '../../assets/images/iporn1.webp'
import ButtonComponent from '../../component/ButtonComponent/ButtonComponent'
import { decreaseAmount, increaseAmount, removeFromCart } from '../../redux/slides/orderSlide'
                ...
                return (
                  <WrapperItemOrder>
                    <div style={{ width: '390px', display: 'flex', alignItems: 'center', gap: 4 }}>
                      ...
                      <img src={imag} style={{ width: '77px', height: '79px', objectFit: 'cover' }} alt='img' />
                      <div>{order?.name}</div>
                    </div>
                    <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      <span>
                      ...
                      <span style={{ color: 'rgb(255, 66, 78' }}>{order?.price * order?.amount}</span>
            ...
            <div style={{ width: '100%' }}>
              ...
              <WrapperTotal>
                ...
                <span style={{ display: 'flex', flexDirection: 'column' }}>
                  <span style={{ color: 'rgb(254, 56, 52)', fontSize: '24px', fontWeight: 'bold' }}>0123</span>
